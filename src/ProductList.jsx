...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart  = (plant) =>{
        setAddedToCart( s => ({...s, [plant.name]: true}));

        dispatch(addItem(plant));// Add product to cart
    }
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <b style={{ position:"relative", top: "-40px", left: "35px"}}>{cart.length ? String(cart.length) : ''}</b>
                    </div>
                </div>
            </div>
            {!showCart ? (
